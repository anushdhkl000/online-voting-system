...
const ManageCandidate = ({
  ...
  const form = useForm({
    initialValues: {
      ...
      members: [{ firstName: "", age: "" }], // Initialize with one member
    },
  });
  const dispatch = useDispatch();
  const candidateId = Math.floor(100000 + Math.random() * 900000);
  ...
  const addMemberField = () => {
    form.insertListItem("members", { firstName: "", age: "" });
  ...
  useEffect(() => {
    if (selectedData) {
      const initialValues = {
        candidateType: selectedData.candidateType || "individual",
        descriptions: selectedData?.descriptions,
      };

      if (selectedData.candidateType === "individual") {
        ...
        initialValues.members = selectedData?.members || [
          { firstName: "", age: "" },
        ];
                  ...
                  <React.Fragment key={index}>
                    <Grid.Col span={{ base: 12, md: 6 }}>
                      <TextInput
                        ...
                        withAsterisk
                        {...form.getInputProps(`members.${index}.firstName`)}
                      />
                    </Grid.Col>
                    <Grid.Col span={{ base: 12, md: 4 }}>
                      <TextInput
